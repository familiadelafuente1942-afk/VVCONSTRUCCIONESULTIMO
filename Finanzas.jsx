...
// VERSION: v24 (saldo restante en cert y pdf, cliente y costo)
...
function CertTab({ modo, obras, data, save, certsDe, indices }) {
  ...
  function imprimirCertificado(c) {
    ...
    const docTit = esCosto ? `CERTIFICADO N° ${certN} · COSTO` : `CERTIFICADO N° ${certN}`;
